 ...
 */
function klenoty_vondracek_child_theme_enqueue_styles() {
    $parent_style = 'klenoty_vondracek_parent_style';
...
add_action( 'wp_enqueue_scripts', 'klenoty_vondracek_child_theme_enqueue_styles' );
